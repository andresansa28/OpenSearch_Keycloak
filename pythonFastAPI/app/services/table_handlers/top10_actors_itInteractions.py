#Trovare i 10 attori (actor) più attivi (in base al numero di documenti) che hanno comunicato usando i tutti i protocolli tranne Modbus e S7Comm in 
      ...
      "must_not": [
        {
          "bool": {
            "should": [
              {
                "match_phrase": {
                  "service.keyword": "modbus"
                }
              },
              {
                "match_phrase": {
                  "service.keyword": "s7comm"
                }
              }
            ],
